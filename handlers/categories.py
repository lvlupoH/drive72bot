...
CATEGORIES = {
    "cat_a": {
        ...
        "packages": {
            ...
            "МОТО3": {"price": 20000, "desc": "VIP курс"},
            "МОТО4": {"price": 25000, "desc": "Индивидуальный"}
        }
    },
    "cat_b": {
        "title": "Категория В",
        "packages": {
            ...
            "АВТО2": {"price": 25000, "desc": "Стандарт"},
            "АВТО3": {"price": 30000, "desc": "Премиум"},
            "АВТО4": {"price": 35000, "desc": "Полный курс"}
        }
    }
}
